...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_NAV] = LAYOUT_split_3x6_3_ex2(
		KC_ESC,  KC_F1,   KC_F2,   KC_F3,       KC_F4,   KC_F5,   KC_F6,      KC_BSPC,    KC_F12,  KC_F11,  KC_F10,      KC_F9,   KC_F8,   KC_F7,
		KC_LSFT, RM_HUEU, RM_SATU, RM_VALU,     RM_SPDU, RM_NEXT, RM_TOGG,    KC_MFFD,    KC_MRWD, KC_UP,   KC_RGHT,     KC_UP,   KC_DOWN, KC_LEFT,
		KC_LCTL, RM_HUED, RM_SATD, RM_VALD,     RM_SPDD, RM_PREV,                         KC_RGHT, KC_DOWN, KC_LEFT,     KC_VOLU, KC_VOLD, KC_NO,
